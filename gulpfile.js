...
gulp.task('sass', function() { // Создаем таск Sass
    return gulp.src('app/scss/**/*.+(scss|sass)') // Берем источник
        ...
        .pipe(autoprefixer(['last 10 versions', '> 1%', 'ie 9'], { cascade: true })) // Создаем префиксы
...
gulp.task('watch', function() {
    ...
    gulp.watch(['app/js/script.js'], gulp.parallel('scripts')); // Наблюдение за главным JS файлом и за библиотеками
});
